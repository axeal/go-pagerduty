...
type Incident struct {
	APIObject                              `bson:",inline"`
	IncidentNumber       uint              `json:"incident_number,omitempty" bson:"incident_number,omitempty"`
	Title                string            `json:"title,omitempty" bson:"title,omitempty"`
	Description          string            `json:"description,omitempty" bson:"description,omitempty"`
	CreatedAt            string            `json:"created_at,omitempty" bson:"created_at,omitempty"`
	PendingActions       []PendingAction   `json:"pending_actions,omitempty" bson:"pending_actions,omitempty"`
	IncidentKey          string            `json:"incident_key,omitempty" bson:"incident_key,omitempty"`
	Service              APIObject         `json:"service,omitempty" bson:"service,omitempty"`
	Assignments          []Assignment      `json:"assignments,omitempty" bson:"assignments,omitempty"`
	Acknowledgements     []Acknowledgement `json:"acknowledgements,omitempty" bson:"acknowledgements,omitempty"`
	LastStatusChangeAt   string            `json:"last_status_change_at,omitempty" bson:"last_status_change_at,omitempty"`
	LastStatusChangeBy   APIObject         `json:"last_status_change_by,omitempty" bson:"last_status_change_by,omitempty"`
	FirstTriggerLogEntry APIObject         `json:"first_trigger_log_entry,omitempty" bson:"first_trigger_log_entry,omitempty"`
	EscalationPolicy     APIObject         `json:"escalation_policy,omitempty" bson:"escalation_policy,omitempty"`
	Teams                []APIObject       `json:"teams,omitempty" bson:"teams,omitempty"`
	Priority             *Priority         `json:"priority,omitempty" bson:"priority,omitempty"`
	Urgency              string            `json:"urgency,omitempty" bson:"urgency,omitempty"`
	Status               string            `json:"status,omitempty" bson:"status,omitempty"`
	Id                   string            `json:"id,omitempty" bson:"id,omitempty"`
	ResolveReason        ResolveReason     `json:"resolve_reason,omitempty" bson:"resolve_reason,omitempty"`
	AlertCounts          AlertCounts       `json:"alert_counts,omitempty" bson:"alert_counts,omitempty"`
	Body                 IncidentBody      `json:"body,omitempty" bson:"body,omitempty"`
	IsMergeable          bool              `json:"is_mergeable,omitempty" bson:"is_mergeable,omitempty"`
}
